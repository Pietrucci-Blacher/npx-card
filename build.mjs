...
const output = `${heading}${newline}${newline}${working}${newline}${twittering}${newline}${mastodoning}${newline}${npming}${newline}${githubing}${newline}${linkedining}${newline}${webing}${newline}${newline}${carding}`;
